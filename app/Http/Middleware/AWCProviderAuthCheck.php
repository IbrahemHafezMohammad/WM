...
class AWCProviderAuthCheck
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $awc_currency = $request->route('currency');

        if (!AWCProvider::authorizeProvider($seamless_secret, $awc_currency)) {

            $result = AWCProvider::authFailed();
