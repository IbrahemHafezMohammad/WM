...
class KMDebitPlayerBalanceRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'transactions.*.authtoken' => ['sometimes', 'nullable', 'string', 'max:2000'],
            ...
            'transactions.*.ipaddress' => ['sometimes', 'nullable', 'string', 'max:40'],
            ...
            'transactions.*.externalbetid' => ['sometimes', 'nullable', 'string', 'max:64'],
            ...
            'transactions.*.commission' => ['sometimes', 'nullable', 'decimal:0,6'],
        ];
    }
